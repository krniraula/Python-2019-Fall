...
##################### Program Description ########################
#
# The following program takes a list of ordered books and generates
# a list of ordinal ranking string (1st, 2nd, 3rd, 4th, etc...) for each book
# It then prints out the 'requested' books along with their corresponding
# ordinal ranking.
