...
book_ranking_numbers = []
#TODO: Use a list comprehension to generate a list of numbers between 1 and the number of books.

book_ordinal_ranking_numbers = []

for book_ranking in book_ranking_numbers:
    if book_ranking == 1:
        book_ordinal_ranking_numbers.append(book_ranking + "st")
    if book_ranking == 2:
        book_ordinal_ranking_numbers.append(book_ranking + "nd")
    if book_ranking == 3:
        book_ordinal_ranking_numbers.append(book_ranking + "rd")
    else:
        book_ordinal_ranking_numbers.append(book_ranking + "th")

print(book_ordinal_ranking_numbers)

book_idx = 0
for book in requested_books:
    if book in ordered_list_of_books:
        print(book_ordinal_ranking_numbers[book_idx] + " " + books)
